    ...
    public void appendInstruction(StringBuilder sbOut) {
        ...
        case Opcodes.PUTFIELD: {
            ...
            if (valueLiteral != null && targetLiteral != null) {
                b.append(funcName).append("(threadStateData, ").append(valueLiteral).append(", ").append(targetLiteral).append(");\n");
                valueOpAppended = true;
                targetOpAppended = true;
            } else {
                String cn1Val;
                ...
                case 'L':
                case '[':
                    b.append("JAVA_OBJECT cn1Val = PEEK_OBJ(1);");
                    b.append("JAVA_OBJECT cn1T = PEEK_OBJ(2);");
                    b.append(funcName).append(funcEnd);
                    b.append("POP_MANY(2);}\n");
                    sbOut.append(b);
                    return;
                case 'D':
                    cn1Val = "JAVA_DOUBLE cn1Val = POP_DOUBLE();";
                    break;
                case 'F':
                    cn1Val = "JAVA_FLOAT cn1Val = POP_FLOAT();";
                    break;
                case 'J':
                    cn1Val = "JAVA_LONG cn1Val = POP_LONG();";
                    break;
                default:
                    cn1Val = "JAVA_INT cn1Val = POP_INT();";
                    break;
                }
                b.append(cn1Val);
                b.append("JAVA_OBJECT cn1T = POP_OBJ();");
                b.append(funcName).append(funcEnd).append("}\n");
            }
