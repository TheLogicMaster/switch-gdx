...
JAVA_BOOLEAN java_nio_NativeUtils_isSwitch___R_boolean(CODENAME_ONE_THREAD_STATE) {
#ifdef __SWITCH__
    return true;
#else
    return false;
...
JAVA_LONG java_nio_NativeUtils_getLong___long_R_long(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1) {
    return *(JAVA_ARRAY_LONG*)__cn1Arg1;
}

JAVA_VOID java_nio_NativeUtils_putLong___long_long(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1, JAVA_LONG __cn1Arg2) {
    *(JAVA_ARRAY_LONG*)__cn1Arg1 = __cn1Arg2;
}

JAVA_INT java_nio_NativeUtils_getInt___long_R_int(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1) {
    return *(JAVA_ARRAY_INT*)__cn1Arg1;
}

JAVA_VOID java_nio_NativeUtils_putInt___long_int(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2) {
    *(JAVA_ARRAY_INT*)__cn1Arg1 = __cn1Arg2;
}

JAVA_SHORT java_nio_NativeUtils_getShort___long_R_short(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1) {
    return *(JAVA_ARRAY_SHORT*)__cn1Arg1;
}

JAVA_VOID java_nio_NativeUtils_putShort___long_short(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1, JAVA_SHORT __cn1Arg2) {
    *(JAVA_ARRAY_SHORT*)__cn1Arg1 = (JAVA_ARRAY_SHORT)__cn1Arg2;
}

JAVA_CHAR java_nio_NativeUtils_getChar___long_R_char(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1) {
    return *(JAVA_ARRAY_CHAR*)__cn1Arg1;
}

JAVA_VOID java_nio_NativeUtils_putChar___long_char(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1, JAVA_CHAR __cn1Arg2) {
    *(JAVA_ARRAY_CHAR*)__cn1Arg1 = __cn1Arg2;
}

JAVA_BYTE java_nio_NativeUtils_getByte___long_R_byte(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1) {
    return *(JAVA_ARRAY_BYTE*)__cn1Arg1;
}

JAVA_VOID java_nio_NativeUtils_putByte___long_byte(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1, JAVA_BYTE __cn1Arg2) {
    *(JAVA_ARRAY_BYTE*)__cn1Arg1 = (JAVA_ARRAY_BYTE)__cn1Arg2;
}
...
JAVA_VOID com_thelogicmaster_switchgdx_SwitchControllerManager_getAxes___float_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT axes) {
    ...
    array[0] = stickLeft.x;
    array[1] = stickLeft.y;
    array[2] = stickRight.x;
    array[3] = stickRight.y;
#else
