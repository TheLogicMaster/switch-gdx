...
"%USERPROFILE%\.SwitchGDX\vcpkg\vcpkg.exe" install angle:x64-uwp sdl2:x64-uwp libffi:x64-uwp curl:x64-uwp freetype:x64-uwp zlib:x64-uwp pthread:x64-uwp libvorbis:x64-uwp libogg:x64-uwp mpg123:x64-uwp
